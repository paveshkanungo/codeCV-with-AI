  ...
  return (
    <div>
        <div className='flex justify-between items-center'>
            ...
            <Link to={"/dashboard"}><Button><HomeIcon/></Button></Link>
            <ThemeColor/>
            </div>
            <div className='flex gap-2'>
                {activeFormIndex>1 && <Button size="sm" onClick={()=>setActiveFormIndex(activeFormIndex-1)} className="flex gap-2"><ArrowLeft/></Button>}
                <Button 
                disabled={!enableNext}
        ...
        activeFormIndex==3 ? <Experience enabledNext={(v)=>setEnableNext(v)}/> : activeFormIndex==4 ? <Education/> : 
